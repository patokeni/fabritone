...
public class BaritoneToast implements Toast
{
    ...
    public Visibility draw(MatrixStack matrixStack, ToastManager toastGui, long delta)
    {
        ...
        toastGui.drawTexture(matrixStack, 0, 0, 0, 32, 160, 32);

        if (this.subtitle == null)
        {
            toastGui.getGame().textRenderer.draw(matrixStack, this.title, 18, 12, -11534256);
        }
        else
        {
            toastGui.getGame().textRenderer.draw(matrixStack, this.title, 18, 7, -11534256);
            toastGui.getGame().textRenderer.draw(matrixStack, this.subtitle, 18, 18, -16777216);
        }
